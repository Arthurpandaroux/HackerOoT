...
DEFINE_ACTOR(En_Nopon, ACTOR_EN_NOPON, ACTOROVL_ALLOC_NORMAL, "En_Nopon")
DEFINE_ACTOR(En_Tirkin, ACTOR_EN_TIRKIN, ACTOROVL_ALLOC_NORMAL, "En_Tirkin")
DEFINE_ACTOR(En_Arma, ACTOR_EN_ARMA, ACTOROVL_ALLOC_NORMAL, "En_Arma")
DEFINE_ACTOR(En_Caterpillar, ACTOR_EN_CATERPILLAR, ACTOROVL_ALLOC_NORMAL, "En_Caterpillar")
DEFINE_ACTOR(En_Ogre, ACTOR_EN_OGRE, ACTOROVL_ALLOC_NORMAL, "En_Ogre")
DEFINE_ACTOR(En_New_Actor, ACTOR_EN_NEW_ACTOR, ACTOROVL_ALLOC_NORMAL, "En_New_Actor")
DEFINE_ACTOR(En_Lacerater_Telethia, ACTOR_EN_LACERATER_TELETHIA, ACTOROVL_ALLOC_NORMAL, "En_Lacerater_Telethia")
DEFINE_ACTOR(En_Spider_Telethia, ACTOR_EN_SPIDER_TELETHIA, ACTOROVL_ALLOC_NORMAL, "En_Spider_Telethia")