...
DEFINE_OBJECT(object_en_nopon, OBJECT_EN_NOPON)
DEFINE_OBJECT(object_en_tirkin, OBJECT_EN_TIRKIN)
DEFINE_OBJECT(object_en_arma, OBJECT_EN_ARMA)
DEFINE_OBJECT(object_en_caterpillar, OBJECT_EN_CATERPILLAR)
DEFINE_OBJECT(object_en_ogre, OBJECT_EN_OGRE)
DEFINE_OBJECT(object_en_new_actor, OBJECT_EN_NEW_ACTOR)
DEFINE_OBJECT(object_en_lacerater_telethia, OBJECT_EN_LACERATER_TELETHIA)
DEFINE_OBJECT(object_en_spider_telethia, OBJECT_EN_SPIDER_TELETHIA)